...
export class BackendEntity {
    ...
    GetHitsURL(
        ...
        if (parameters['page'] !== undefined) {
            queryParameters['page'] = this.convertParameterCollectionFormat(parameters['page'], '')
        }

        if (parameters['pageSize'] !== undefined) {
            queryParameters['pageSize'] = this.convertParameterCollectionFormat(parameters['pageSize'], '')
        }
    ...
    ): Promise<ResponseWithBody<200, PagedList<Hit>> | ResponseWithBody<401, void> | ResponseWithBody<403, void> | ResponseWithBody<500, void>> {
        const domain = parameters.$domain ? parameters.$domain : this.domain
        let path = '/analytics/hits'
        if (parameters.$path) {
            path = typeof parameters.$path === 'function' ? parameters.$path(path) : parameters.$path
    ...
    ): Promise<ResponseWithBody<200, ActionResult> | ResponseWithBody<401, void> | ResponseWithBody<403, void> | ResponseWithBody<500, void>> {
        const domain = parameters.$domain ? parameters.$domain : this.domain
        let path = '/billing/invoices/{id}'
        if (parameters.$path) {
            path = typeof parameters.$path === 'function' ? parameters.$path(path) : parameters.$path
    ...
    GetDashboardHitsDailyURL(
        ...
        if (parameters['startDate'] !== undefined) {
            queryParameters['startDate'] = this.convertParameterCollectionFormat(parameters['startDate'], '')
        }

        if (parameters['endDate'] !== undefined) {
            queryParameters['endDate'] = this.convertParameterCollectionFormat(parameters['endDate'], '')
        }
     ...
     */
    GetDashboardHitsDaily(
        parameters: {
            authorization?: string
            startDate?: string
            endDate?: string
        } & CommonRequestOptions
    ): Promise<ResponseWithBody<200, Response_GetDashboardHitsDaily_200> | ResponseWithBody<401, void> | ResponseWithBody<403, void> | ResponseWithBody<500, void>> {
        const domain = parameters.$domain ? parameters.$domain : this.domain
        let path = '/dashboard/hits/daily'
        if (parameters.$path) {
            path = typeof parameters.$path === 'function' ? parameters.$path(path) : parameters.$path
    ...
    ): Promise<ResponseWithBody<200, Response_GetDashboardInvoices_200> | ResponseWithBody<401, void> | ResponseWithBody<403, void> | ResponseWithBody<500, void>> {
        const domain = parameters.$domain ? parameters.$domain : this.domain
        let path = '/dashboard/invoices'
        if (parameters.$path) {
            path = typeof parameters.$path === 'function' ? parameters.$path(path) : parameters.$path
    ...
    DeleteApiKeyURL(
        ...
        path = path.replace('{apiKeyid}', `${encodeURIComponent(this.convertParameterCollectionFormat(parameters['apiKeyid'], '').toString())}`)
    ...
    DeleteApiKeyDomainURL(
        ...
        path = path.replace('{domainId}', `${encodeURIComponent(this.convertParameterCollectionFormat(parameters['domainId'], '').toString())}`)
    ...
    GetTimeZonesByCountryURL(
        ...
        path = path.replace('{country}', `${encodeURIComponent(this.convertParameterCollectionFormat(parameters['country'], '').toString())}`)
