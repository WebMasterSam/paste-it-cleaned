...
export const PayPalIcon = (props: HTMLProps<SvgAttributes>) => (
    <svg version="1.1" x="0px" y="0px" viewBox="0 175 504 150" {...(props as any)}>
        <path
            fill="#139AD6"
	...
	c0-1.6-0.8-2.4-2.4-2.4h-12.8C488,221.2,487.2,222,486.4,223.6"
        ...
        <path
            fill="#263B80"
            d="M92,197.2c-5.6-6.4-16-9.6-30.4-9.6h-40c-2.4,0-4.8,2.4-5.6,4.8L0,297.2c0,2.4,1.6,4,3.2,4H28
	...
	C99.2,210,97.6,203.6,92,197.2"
        ...
        <path
            fill="#139AD6"
            d="M97.6,220.4L97.6,220.4c0,0.8,0,1.6,0,2.4c-5.6,27.2-23.2,36-46.4,36h-12c-2.4,0-4.8,2.4-5.6,4.8
	...
	c1.6-9.6,0.8-18.4-4-24C101.6,222.8,100,221.2,97.6,220.4"
        ...
        <path
            fill="#232C65"
            d="M92,218c-0.8,0-1.6-0.8-2.4-0.8s-1.6,0-2.4-0.8c-3.2-0.8-6.4-0.8-10.4-0.8H45.6c-0.8,0-1.6,0-2.4,0.8
