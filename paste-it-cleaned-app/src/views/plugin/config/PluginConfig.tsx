                            ...
                            <Grid container spacing={3}>
                                <Grid item xs={12}>
                                    ...
                                    <TooltipHelp title={'Removes all span tags from pasted source.'} placement="right">
                                        <FormControlLabel
                                            control={<Switch checked={this.state.removeSpanTags} onChange={() => this.handleChange('removeSpanTags', !this.state.removeSpanTags)} value="checkedB" color="primary" />}
                                    ...
                                    <TooltipHelp title={'Removes all iframes from the pasted source.'} placement="right">
                                        <FormControlLabel
                                            control={<Switch checked={this.state.removeIframes} onChange={() => this.handleChange('removeIframes', !this.state.removeIframes)} value="checkedB" color="primary" />}
                                            label="Remove iframes"
                                        />
                                    </TooltipHelp>
