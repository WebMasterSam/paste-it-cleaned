...
export const TextIcon = (props: HTMLProps<SvgAttributes> & Position) => (
    <svg version="1.1" x="0px" y="0px" viewBox="0 0 512 512" {...(props as any)}>
        <path
            fill="#444444"
            d="M0,15.671v136.155h80.073v-35.53c0-12.989,10.567-23.556,23.557-23.556h103.673v293.536c0,18.527-15.072,33.6-33.6,33.6
