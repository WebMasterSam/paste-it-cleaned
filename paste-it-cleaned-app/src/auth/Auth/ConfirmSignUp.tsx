...
export default class ConfirmSignUp extends AuthPiece<IAuthPieceProps, IAuthPieceState> {
    ...
    showComponent(theme: any) {
        ...
        return (
            <FormSection theme={theme} data-test={auth.confirmSignUp.section} className="auth-form">
                ...
                <SectionBody theme={theme} data-test={auth.confirmSignUp.bodySection}>
                    <FormField theme={theme}>
                        ...
                        <Input placeholder={I18n.get('Username')} theme={theme} key="username" name="username" onChange={this.handleInputChange} disabled={username} value={username ? username : ''} data-test={auth.confirmSignUp.usernameInput} />
                    </FormField>

                    <FormField theme={theme}>
                        <InputLabel theme={theme}>{I18n.get('Confirmation Code')} *</InputLabel>
                        <Input autoFocus placeholder={I18n.get('Enter your code')} theme={theme} key="code" name="code" autoComplete="off" onChange={this.handleInputChange} data-test={auth.confirmSignUp.confirmationCodeInput} />
                        <Hint theme={theme}>
