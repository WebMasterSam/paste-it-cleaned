...
export class FederatedButtons extends React.Component<IFederatedButtonsProps, {}> {
    google(google_client_id: any) {
        ...
        return <GoogleButton google_client_id={google_client_id} theme={theme} onStateChange={onStateChange} />
    }
    ...
    facebook(facebook_app_id: any) {
        ...
        const { theme, onStateChange } = this.props
        return <FacebookButton facebook_app_id={facebook_app_id} theme={theme} onStateChange={onStateChange} />
    }
    ...
    amazon(amazon_client_id: any) {
        ...
        const { theme, onStateChange } = this.props
        return <AmazonButton amazon_client_id={amazon_client_id} theme={theme} onStateChange={onStateChange} />
    }
    ...
    OAuth(oauth_config: any) {
        ...
        const { theme, onStateChange } = this.props
        return <OAuthButton label={oauth_config ? oauth_config.label : undefined} theme={theme} onStateChange={onStateChange} />
    }
    ...
    auth0(auth0: any) {
        ...
        const { theme, onStateChange } = this.props
        return <Auth0Button label={auth0 ? auth0.label : undefined} theme={theme} onStateChange={onStateChange} auth0={auth0} />
    }
...
export default class FederatedSignIn extends React.Component<any, any> {
    render() {
        ...
        const theme = this.props.theme || AmplifyTheme
        return (
            <FormSection theme={theme} data-test={auth.federatedSignIn.section} className="auth-form">
                <SectionBody theme={theme} data-test={auth.federatedSignIn.bodySection}>
                    <FederatedButtons federated={federated} theme={theme} authState={authState} onStateChange={onStateChange} data-test={auth.federatedSignIn.signInButtons} />
                </SectionBody>
            </FormSection>
        )
    }
