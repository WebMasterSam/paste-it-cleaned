...
export default function withAuth0(Comp: any, options?: any) {
        ...
        initialize() {
            ...
            if (authState !== 'signedIn') {
                this._auth0.parseHash((err: any, authResult: any) => {
                    ...
                    this._auth0.client.userInfo(authResult.accessToken, (err: any, user: any) => {
...
const Button = (props: any) => (
    <SignInButton id={auth0SignInButton} onClick={props.auth0SignIn} theme={props.theme || AmplifyTheme} variant={'auth0SignInButton'}>
        ...
        <SignInButtonContent theme={props.theme || AmplifyTheme}>{props.label || 'Sign In with Auth0'}</SignInButtonContent>
    </SignInButton>
)
