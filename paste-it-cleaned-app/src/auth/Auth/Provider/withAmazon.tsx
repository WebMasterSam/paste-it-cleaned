...
export default function withAmazon(Comp: any) {
    return class extends React.Component<any, any> {
        ...
        federatedSignIn(response: any) {
            ...
            //@ts-ignore
            const amz = window.amazon
            amz.Login.retrieveProfile((userInfo: any) => {
                if (!userInfo.success) {
        ...
        render() {
            //@ts-ignore
            const amz = window.amazon
            return <Comp {...this.props} amz={amz} amazonSignIn={this.signIn} amazonSignOut={this.signOut} />
        }
    }
}

const Button = (props: any) => (
    <SignInButton id={amazonSignInButton} onClick={props.amazonSignIn} theme={props.theme || AmplifyTheme} variant={'amazonSignInButton'}>
        ...
        <SignInButtonContent theme={props.theme || AmplifyTheme}>{I18n.get('Sign In with Amazon')}</SignInButtonContent>
    </SignInButton>
)
