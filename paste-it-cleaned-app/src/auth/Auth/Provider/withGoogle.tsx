...
export default function withGoogle(Comp: any) {
    return class extends React.Component<any, any> {
        ...
        async federatedSignIn(googleUser: any) {
        ...
        signOut() {
            ...
            authInstance.then((googleAuth: any) => {
                if (!googleAuth) {
...
const Button = (props: any) => (
    <SignInButton id={googleSignInButton} onClick={props.googleSignIn} theme={props.theme || AmplifyTheme} variant="googleSignInButton">
        <SignInButtonIcon theme={props.theme || AmplifyTheme}>
            <svg viewBox="0 0 256 262" xmlns="http://ww0w.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
        ...
        <SignInButtonContent theme={props.theme || AmplifyTheme}>{I18n.get('Sign In with Google')}</SignInButtonContent>
    </SignInButton>
)
