    ...
    renderUsernameField(theme: any) {
        return (
            <FormField theme={theme}>
                ...
                <Input autoFocus placeholder={I18n.get('Enter your email')} theme={theme} key="email" name="email" type="email" onChange={this.handleInputChange} data-test={auth.genericAttrs.emailInput} />
            </FormField>
        )
    }

    getUsernameLabel() {
        return labelMap[UsernameAttributes.EMAIL]
    }
